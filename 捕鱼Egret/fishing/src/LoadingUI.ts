class LoadingUI extends egret.Sprite implements burn.base.IDestory{

    private _loadingUI:FishLoadingUI;
    private _movie:LoadingAnimUI;
    //循环Timer
    private _timer:egret.Timer;
    //tips下标
    private _tipsIdx:number = 0;
    //tips文本数组
    private _tipsArr:Array<string>;
    //loading tips
    private _tipsTxt:eui.Label;
    ...
    public initView():void {
        ...
        //logo
        RES.getResAsync("logo_png", function(data, key):void {
            let logoImg = new egret.Bitmap(data);
        ...
        //loading tips
        let configVo = game.table.T_Config_Table.getVoByKey(24); 
...
class LoadingAnimUI extends eui.Component {
    ...
    YiYuan:eui.Image;
    ShaYu_Bao1:eui.Image;
    ShaYu_Bao2:eui.Image;
    ShaYu_Bao3:eui.Image;
    ShaYu_Bao4:eui.Image;
    ShaYu_DanTou:eui.Image;
    ShaYu_Huo:eui.Image;
    ShaYu_TuoWei:eui.Image;
    ShaYu_Qi:eui.Image;
    ShaYu_Pao:eui.Image;
    ShaYu_Zhao:eui.Image;
    ShaYu_Yan2:eui.Image;
    ShaYu_Yan1:eui.Image;
    ShaYu_Zui:eui.Image;
    ShaYu_ShenTI:eui.Image;
    ShaYu_Chi:eui.Image;
    Lan_Yan:eui.Image;
    Lan_Zui:eui.Image;
    Lan_R_Qi:eui.Image;
    lan_ShenTi:eui.Image;
    Lan_L_Qi:eui.Image;
    HeTun_Zui:eui.Image;
    HeTun_Yan_L:eui.Image;
    HeTun_Yan_R:eui.Image;
    HeTun_L_Chi:eui.Image;
    HeTun_ShenTI:eui.Image;
    HeTun_R_Chi:eui.Image;
    HeTun_WeiBa:eui.Image;
    XiaoChou_Zui:eui.Image;
    XiaoChou_R_Chi:eui.Image;
    XiaoChou_R_Yan:eui.Image;
    XiaoChou_L_Yan:eui.Image;
    XiaoChou_ShenTI:eui.Image;
    WuGui_Zui:eui.Image;
    WuGui_Yan_L:eui.Image;
    WuGui_Yan_R:eui.Image;
    WuGui_Tou:eui.Image;
    WuGui_R_QI:eui.Image;
    WuGui_Ke:eui.Image;
    WuGui_L_Qi:eui.Image;
    Zi_Zui:eui.Image;
    Zi_Yan:eui.Image;
    Zi_R_Qi:eui.Image;
    Zi_ShenTi:eui.Image;
    ...
    public startAction() {
        let self = this;
        this.clearAction();
        let twShayuPao = egret.Tween.get(this.ShaYu_Pao, {loop: false});
        ...
        let twShaYu_Bao4 = egret.Tween.get(this.ShaYu_Bao4, {loop: false});
        twShaYu_Bao4.set({x:497, y:235, alpha: 0});
        twShaYu_Bao4.wait(500)
                    .set({alpha: 0});
        let twShaYu_Chi = egret.Tween.get(this.ShaYu_Chi, {loop: false});
        twShaYu_Chi.to({rotation: -3, y: 89}, 1000)
                   .to({rotation: 0, y: 105}, 1000)
                   .to({rotation: -3, y: 89}, 1000)
                   .to({rotation: 0, y: 105}, 1000);
                
        let twShaYu_ShenTI = egret.Tween.get(this.ShaYu_ShenTI, {loop: false});
        twShaYu_ShenTI.to({y: 143}, 1000)
                      .to({y: 156}, 1000)
                      .to({y: 143}, 1000)
                      .to({y: 156}, 1000);

        let twShaYu_Zui = egret.Tween.get(this.ShaYu_Zui, {loop: false});
        twShaYu_Zui.to({y: 118, rotation: -5}, 1000)
                   .to({y: 131, rotation: 0}, 1000)
                   .to({y: 118, x:636, rotation: -5}, 1000)
                   .to({y: 131, rotation: 0}, 1000);

        let twShaYu_Yan1 = egret.Tween.get(this.ShaYu_Yan1, {loop: false});
        ...
        let twShaYu_Yan2 = egret.Tween.get(this.ShaYu_Yan2, {loop: false});
        ...
        let twShaYu_Zhao = egret.Tween.get(this.ShaYu_Zhao, {loop: false});
        twShaYu_Zhao.to({y: 9}, 1000)
                    .to({y: 22}, 1000)
                    .to({y: 9}, 1000)
                    .to({y: 24}, 1000);

        let twShaYu_Qi = egret.Tween.get(this.ShaYu_Qi, {loop: false});
        twShaYu_Qi.to({y: 149, rotation: -13}, 1000)
                  .to({y: 162, rotation: 0}, 1000)
                  .to({y: 149, rotation: -13}, 1000)
                  .to({y: 162, rotation: 0}, 1000);
        
        let twShaYu_TuoWei = egret.Tween.get(this.ShaYu_TuoWei, {loop: false});
        twShaYu_TuoWei.set({alpha: 0})
                      .to({alpha: 1}, 250)
                      .to({alpha: 0, y: 166}, 750);
                      
        let twShaYu_Huo = egret.Tween.get(this.ShaYu_Huo, {loop: false});
        ...
        let twShaYu_DanTou = egret.Tween.get(this.ShaYu_DanTou, {loop: false});
        ...
        let twShaYu_Bao3 = egret.Tween.get(this.ShaYu_Bao3, {loop: false});
        ...
        let twShaYu_Bao2 = egret.Tween.get(this.ShaYu_Bao2, {loop: false});
        ...
        let twShaYu_Bao1 = egret.Tween.get(this.ShaYu_Bao1, {loop: false});
        ...
        let twLan_Yan = egret.Tween.get(this.Lan_Yan, {loop: false});
        ...
        let twLan_Zui = egret.Tween.get(this.Lan_Zui, {loop: false});
        ...
        let twLan_R_Qi = egret.Tween.get(this.Lan_R_Qi, {loop: false});
        ...
        let twlan_ShenTi = egret.Tween.get(this.lan_ShenTi, {loop: false});
        twlan_ShenTi.to({x: 1054.48, y: 500.25}, 1000)
                    .to({x: 1046.5, y: 494.93}, 1000)
                    .to({x: 1054.48, y: 500.25}, 1000)
                    .to({x: 1046.5, y: 494.93}, 1000);

        let twLan_L_Qi = egret.Tween.get(this.Lan_L_Qi, {loop: false});
        ...
        let twHeTun_WeiBa = egret.Tween.get(this.HeTun_WeiBa, {loop: false});
        ...
        let twHeTun_ShenTI = egret.Tween.get(this.HeTun_ShenTI, {loop: false});
        twHeTun_ShenTI.to({y: 250, x: 197}, 1000)
                      .to({y: 262, x: 205}, 1000)
                      .to({y: 250, x:197}, 1000)
                      .to({y: 262, x: 205}, 1000);

        let twHeTun_L_Chi = egret.Tween.get(this.HeTun_L_Chi, {loop: false});
        ...
        let twHeTun_Yan_R = egret.Tween.get(this.HeTun_Yan_R, {loop: false});
        ...
        let twHeTun_Yan_L = egret.Tween.get(this.HeTun_Yan_L, {loop: false});
        ...
        let twHeTun_Zui = egret.Tween.get(this.HeTun_Zui, {loop: false});
        ...
        let twXiaoChou_Zui = egret.Tween.get(this.XiaoChou_Zui, {loop: false});
        twXiaoChou_Zui.to({x: 1101, y: 290}, 1000)
                      .to({x: 1093, y: 302}, 1000)
                      .to({x: 1101, y: 290}, 1000)
                      .to({x: 1093, y: 302}, 1000);

        let twXiaoChou_R_Chi = egret.Tween.get(this.XiaoChou_R_Chi, {loop: false});
        ...
        let twXiaoChou_R_Yan = egret.Tween.get(this.XiaoChou_R_Yan, {loop: false});
        ...
        let twXiaoChou_L_Yan = egret.Tween.get(this.XiaoChou_L_Yan, {loop: false});
        ...
        let twWuShi = egret.Tween.get(this.WuShi, {loop:false });
        ...
        let twYiYuan = egret.Tween.get(this.YiYuan, {loop: false});
