module game.table {
	...
	export class T_Config_Table {
		public static getVoByKey(key:number):T_Config {
			var len = _T_Config_.length;
			let data: T_Config = SerchUtil.binary_search(_T_Config_, "id", 0, len, key);
			return data;
		}
		
		public static getAllVo():Array<T_Config> {
			return _T_Config_;
		}
	}
