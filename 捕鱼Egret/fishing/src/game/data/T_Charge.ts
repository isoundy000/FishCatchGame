module game.table {
	...
	export class T_Charge_Table {
		public static getVoByKey(key:number):T_Charge {
			var len = _T_Charge_.length;
			let data: T_Charge = SerchUtil.binary_search(_T_Charge_, "id", 0, len, key);
			return data;
		}
		
		public static getAllVo():Array<T_Charge> {
			return _T_Charge_;
		}
	}
