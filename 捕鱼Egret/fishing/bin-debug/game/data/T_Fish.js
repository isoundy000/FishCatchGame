...
(function (game) {
    ...
    (function (table) {
        ...
        table.T_Fish = T_Fish;
        __reflect(T_Fish.prototype, "game.table.T_Fish");
        var T_Fish_Table = (function () {
            function T_Fish_Table() {
            }
            T_Fish_Table.getVoByKey = function (key) {
                var len = _T_Fish_.length;
                var data = table.SerchUtil.binary_search(_T_Fish_, "id", 0, len, key);
                return data;
            };
            T_Fish_Table.getAllVo = function () {
                return _T_Fish_;
            };
            return T_Fish_Table;
        }());
        table.T_Fish_Table = T_Fish_Table;
        __reflect(T_Fish_Table.prototype, "game.table.T_Fish_Table");
        var _T_Fish_ = [
...
//# sourceMappingURL=T_Fish.js.map