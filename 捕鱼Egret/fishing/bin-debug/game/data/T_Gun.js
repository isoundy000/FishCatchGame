    ...
    (function (table) {
        var T_Gun = (function () {
            function T_Gun() {
                ...
                this.bulletNum = 0;
                //解锁/锻造消耗
                this.upgradeOrForgeCost = "";
                //解锁/锻造奖励
                this.upgradeOrForgeAward = "";
                //锻造还需消耗
                this.forgeSuccessAlsoCost = "";
                //炮台能力1类型
                this.abilityType1 = 0;
                //炮台能力1
                this.gunAbility1 = 0;
        ...
        table.T_Gun = T_Gun;
        __reflect(T_Gun.prototype, "game.table.T_Gun");
        var T_Gun_Table = (function () {
            function T_Gun_Table() {
            }
            T_Gun_Table.getVoByKey = function (key) {
                var len = _T_Gun_.length;
                var data = table.SerchUtil.binary_search(_T_Gun_, "id", 0, len, key);
                return data;
            };
            T_Gun_Table.getAllVo = function () {
                return _T_Gun_;
            };
            return T_Gun_Table;
        }());
        table.T_Gun_Table = T_Gun_Table;
        __reflect(T_Gun_Table.prototype, "game.table.T_Gun_Table");
        var _T_Gun_ = [
